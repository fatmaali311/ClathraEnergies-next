...
const ValorisationHero = ({ hero = {}, images = {}, config = {} }) => {
  const bg = getImageUrl(images?.valorisation_hero_image || '')
  ...
  return (
    ...
    >
      ...
      <motion.div className="relative z-10 text-center px-4">
        ...
        >
          {hero.title || 'Valorisation Solutions'}
        </motion.h2>
        {hero.sub_title && (
...
export default ValorisationHero;
