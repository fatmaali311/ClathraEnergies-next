          ...
          {steps.map((step, index) => (
            <motion.div
              ...
              className={`absolute 
                ...
                max-w-[160px] lg:max-w-[220px]`}
            >
              {/* Step Number */}
              <div
                className={`${colors[index]} rounded-full aspect-square 
                w-10 h-10 lg:w-14 lg:h-14 flex items-center justify-center shadow-md`}
              >
              ...
              {images[`steps[${index}]`] && (
                <div className="w-10 h-10 lg:w-14 lg:h-14">
                  <img
                    src={getImageUrl(images[`steps[${index}]`])}
                    alt={step.text}
              ...
              {/* Step Text */}
              <p className="text-gray-700 text-base lg:text-lg leading-snug font-medium text-center mt-0.5">
                {step.text}
              </p>
            </motion.div>
          ))}
          ...
          <div className="space-y-3 max-w-sm mx-auto">
            {steps.map((step, index) => (
              ...
              >
                ...
                {/* Text */}
                <p className="text-gray-700 text-sm leading-snug font-medium text-center">
                  {step.text}
                </p>
              </motion.div>
            ))}
